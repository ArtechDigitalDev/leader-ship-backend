...
# Set up trusted host middleware (disabled for cloud deployments)
# Railway/Render/Vercel have their own host validation
# Uncomment only if you need strict host validation in local dev
# app.add_middleware(
